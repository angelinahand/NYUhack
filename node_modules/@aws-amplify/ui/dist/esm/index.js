...
`),"breakpoint"in c&&(u+=`
@media (min-width: ${a.breakpoints.values[c.breakpoint]}px) {
  [data-amplify-theme="${l}"] {
    ${g}
  }
}
...
`),C(m({},c),{tokens:b})})),{tokens:t,breakpoints:s,name:l,cssText:u,overrides:v}}r();r();function xs(o){return typeof o=="object"?o.hasOwnProperty("value"):!1}var Is=Br({name:"default-theme"},Q);export{x as AuthChallengeNames,wt as DefaultTexts,jr as FederatedIdentityProviders,j as LoginMechanismArray,G as authInputAttributes,Ba as censorAllButFirstAndLast,Ma as censorPhoneNumber,Ka as countryDialCodes,Cn as createAuthenticatorMachine,Br as createTheme,Is as defaultTheme,Kr as getActorContext,J as getActorState,Ua as getAliasInfoFromContext,Na as getConfiguredAliases,Ga as getFormDataFromEvent,$r as getSendEventAliases,Yr as getServiceContextFacade,Oa as getServiceFacade,At as hasTranslation,xs as isDesignToken,Fa as listenToAuthHub,fa as signUpFieldsWithDefault,ha as signUpFieldsWithoutDefault,Tt as translate,Dt as translations};
