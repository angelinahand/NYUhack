...
declare function FormFields$1(): JSX.Element;
...
declare type AuthenticatorContextValue = {
 ...
 */
declare type AuthenticatorContext = ReturnType<typeof getServiceFacade>;
/**
 ...
 */
declare type Selector = (context: AuthenticatorContext) => Array<any>;
declare const useAuthenticator: (selector?: Selector) => {
    _state: AuthMachineState;
    _send: (event: _aws_amplify_ui.AuthEvent | "CHANGE" | "BLUR" | "FEDERATED_SIGN_IN" | "RESEND" | "RESET_PASSWORD" | "SIGN_IN" | "SIGN_OUT" | "SIGN_UP" | "SKIP" | "SUBMIT" | "INIT" | "done.invoke.signInActor" | "done.invoke.signUpActor" | "done.invoke.signOutActor" | "done.invoke.resetPasswordActor" | xstate.SCXML.Event<_aws_amplify_ui.AuthEvent> | xstate.Event<_aws_amplify_ui.AuthEvent>[], payload?: xstate.EventData) => xstate.State<_aws_amplify_ui.AuthContext, _aws_amplify_ui.AuthEvent, any, {
        value: any;
...
interface IconProps extends ViewProps {
     ...
     */
    paths?: Array<React$1.SVGAttributes<SVGPathElement>>;
}
...
type index_CollectionBaseProps<Item> = CollectionBaseProps<Item>;
type index_ListCollectionProps<Item> = ListCollectionProps<Item>;
type index_GridCollectionProps<Item> = GridCollectionProps<Item>;
type index_CollectionProps<Item> = CollectionProps<Item>;
...
type index_StyleProp<PropertyType> = StyleProp<PropertyType>;
type index_ResponsiveObject<PropertyType> = ResponsiveObject<PropertyType>;
type index_ResponsiveStyle<PropertyType> = ResponsiveStyle<PropertyType>;
...
type index_HTMLElementType<Element extends ElementType> = HTMLElementType<Element>;
type index_ElementProps<Element extends ElementType> = ElementProps<Element>;
type index_PrimitiveProps<Props extends ViewProps, Element extends ElementType> = PrimitiveProps<Props, Element>;
type index_PrimitivePropsWithRef<Props extends ViewProps, Element extends ElementType> = PrimitivePropsWithRef<Props, Element>;
type index_Primitive<Props extends ViewProps, Element extends ElementType> = Primitive<Props, Element>;
