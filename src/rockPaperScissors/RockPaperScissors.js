...
import Scissors from './icons/scissor.png';
          ...
          >
            <div>
              <div className="game-state-content">
                ...
                {/* <p>you {gameState}!</p> */}
                {gameState === 'win' && <p>Congratulations you won against Mode!</p>}
                {gameState === 'lose' && <p>Sorry, Mode won this game!</p>}
                {gameState === 'draw' && <p>Mode and you are on the same page!</p>}
